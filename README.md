...
Project name is `Sara Lifestyle` which `an Ecommerce Application`.
...
To contribute to Sara, follow these steps:
...
Thanks to the following people who have contributed to Sara project:
